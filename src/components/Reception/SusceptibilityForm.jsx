...
function SusceptibilityForm() {
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const res = await fetch('http://localhost:3000/api/susceptibility', {
            method: 'POST',
  ...
  return (
    <div className="p-10 space-y-6">
      <h1 className="text-neutral-500 font-bold text-4xl">Susceptibility Form</h1>
...
export default SusceptibilityForm
