...
function TestTubesMetersForm() {
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        e.preventDefault();
        const { from, to, from_meters, to_meters, reception_id } = formData;
        ...
        try {
          const res = await fetch('http://localhost:3000/api/test_tubes_meters', {
            method: 'POST',
  ...
  return (
    <div className="p-10 space-y-6">
      <h1 className="text-neutral-500 font-bold text-4xl">Test Tubes & Meters Form</h1>
...
export default TestTubesMetersForm
