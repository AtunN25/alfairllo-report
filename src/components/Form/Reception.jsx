            ...
            <div className="px-6 py-4">
                ...
                <div className='flex gap-4'>
                    <input
                        ...
                        placeholder="actualize la oberservacion del pozo "
                        className="w-full selection:bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-5 py-4 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                    />
