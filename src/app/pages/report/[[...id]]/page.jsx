  ...
  return (
    <div className='bg-black h-screen w-full p-16 border rounded-lg text-white '>
      ...
      <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 space-y-4 flex flex-col">
        <a href="#">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Generar Reporte PDF</h5>
        </a>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">en caso de desear generar reportes anteriores , cambie el valor por el id del reporte que desea generar ...</p>
